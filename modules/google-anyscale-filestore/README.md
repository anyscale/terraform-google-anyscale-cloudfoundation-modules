...
| <a name="input_anyscale_filestore_fileshare_capacity_gb"></a> [anyscale\_filestore\_fileshare\_capacity\_gb](#input\_anyscale\_filestore\_fileshare\_capacity\_gb) | (Optional) The capacity of the fileshare to create.<br/><br/>This must be at least 1024 GiB for the standard tier, or 2560 GiB for the premium tier.<br/>Must be a multiple of 256 GiB.<br/><br/>ex:<pre>anyscale_filestore_fileshare_capacity_gb = 2560</pre> | `number` | `2560` | no |
