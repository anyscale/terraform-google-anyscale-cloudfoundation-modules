...
| <a name="input_gke_pod_range_cidr"></a> [gke\_pod\_range\_cidr](#input\_gke\_pod\_range\_cidr) | (Optional) The cidr block for GKE Pods.<br/><br/>This VPC terraform will add this as a secondary range to the Private VPC Subnet if defined.<br/>Requires `private_subnet_cidr` to be set.<br/><br/>ex:<pre>gke_pod_range_cidr = "192.168.64.0/22"</pre> | `string` | `null` | no |
| <a name="input_gke_pods_range_name"></a> [gke\_pods\_range\_name](#input\_gke\_pods\_range\_name) | (Optional) Explicit name for the GKE Pods subnet range.<br/><br/>If empty, the range name for GKE Pods will be generated using the `gke_pods_range_name_suffix` and VPC Name parameters.<br/><br/>ex:<pre>gke_pods_range_name = "gke-pods-range"</pre> | `string` | `null` | no |
| <a name="input_gke_pods_range_name_suffix"></a> [gke\_pods\_range\_name\_suffix](#input\_gke\_pods\_range\_name\_suffix) | (Optional) The suffix of the range name for the GKE Pods.<br/><br/>Creates a unique range name ending with the specified suffix.<br/><br/>ex:<pre>gke_service_range_name_suffix = "gke-pods-range"</pre> | `string` | `"gke-pods-range"` | no |
| <a name="input_gke_service_range_name_suffix"></a> [gke\_service\_range\_name\_suffix](#input\_gke\_service\_range\_name\_suffix) | (Optional) The suffix of the range name for the GKE Service Pods.<br/><br/>Creates a unique range name ending with the specified suffix.<br/><br/>ex:<pre>gke_service_range_name_suffix = "gke-services-range"</pre> | `string` | `"gke-services-range"` | no |
| <a name="input_gke_services_range_cidr"></a> [gke\_services\_range\_cidr](#input\_gke\_services\_range\_cidr) | (Optional) The cidr block for GKE Service Pods.<br/><br/>This VPC terraform will add this as a secondary range to the Private VPC Subnet if defined.<br/>Requires `private_subnet_cidr` to be set.<br/><br/>ex:<pre>gke_services_range_cidr = "192.168.1.0/24"</pre> | `string` | `null` | no |
| <a name="input_gke_services_range_name"></a> [gke\_services\_range\_name](#input\_gke\_services\_range\_name) | (Optional) Explicit name for the GKE Service Pods subnet range.<br/><br/>If empty, the range name for GKE Service Pods will be generated using the `gke_service_range_name_suffix` and VPC Name parameters.<br/><br/>ex:<pre>gke_services_subnet_name = "gke-services-range"</pre> | `string` | `null` | no |
...
| <a name="input_nat_enable_dynamic_port_allocation"></a> [nat\_enable\_dynamic\_port\_allocation](#input\_nat\_enable\_dynamic\_port\_allocation) | (Optional) Determines if NAT should allocate ports dynamically.<br/><br/>ex:<pre>nat_enable_dynamic_port_allocation = true</pre> | `bool` | `false` | no |
...
| <a name="input_nat_max_ports_per_vm"></a> [nat\_max\_ports\_per\_vm](#input\_nat\_max\_ports\_per\_vm) | (Optional) Maximum number of ports allocated to a VM from this NAT config.<br/><br/>Changing this forces a new NAT to be created.<br/><br/>ex:<pre>nat_max_ports_per_vm = 1024</pre> | `string` | `"65536"` | no |
| <a name="input_nat_min_ports_per_vm"></a> [nat\_min\_ports\_per\_vm](#input\_nat\_min\_ports\_per\_vm) | (Optional) Minimum number of ports allocated to a VM from this NAT config.<br/><br/>Changing this forces a new NAT to be created.<br/><br/>ex:<pre>nat_min_ports_per_vm = 32</pre> | `string` | `"32"` | no |
