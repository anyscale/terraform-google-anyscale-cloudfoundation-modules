...
output "anyscale_iam_service_account_email" {
  ...
  value       = module.google_anyscale_v2_privatenetwork.iam_anyscale_access_service_acct_email
}

output "anyscale_iam_cluster_node_service_acct_email" {
  description = "The Anyscale cluster service account email."
  value       = module.google_anyscale_v2_privatenetwork.iam_anyscale_cluster_node_service_acct_email
}
