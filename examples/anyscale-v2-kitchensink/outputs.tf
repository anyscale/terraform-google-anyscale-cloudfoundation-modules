...
object_storage:
  bucket_name: gs://${module.google_anyscale_v2_kitchensink.cloudstorage_bucket_name}
file_storage:
  file_storage_id: projects/${module.google_anyscale_v2_kitchensink.project_name}/locations/${module.google_anyscale_v2_kitchensink.filestore_location}/instances/${module.google_anyscale_v2_kitchensink.filestore_name}
gcp_config:
  project_id: ${module.google_anyscale_v2_kitchensink.project_name}
  vpc_name: ${module.google_anyscale_v2_kitchensink.vpc_name}
  subnet_names:
    - ${module.google_anyscale_v2_kitchensink.public_subnet_name}
  firewall_policy_names:
    - ${module.google_anyscale_v2_kitchensink.vpc_firewall_policy_name}
  anyscale_service_account_email: ${module.google_anyscale_v2_kitchensink.iam_anyscale_access_service_acct_email}
  cluster_service_account_email: ${module.google_anyscale_v2_kitchensink.iam_anyscale_cluster_node_service_acct_email}
  provider_name: ${module.google_anyscale_v2_kitchensink.iam_workload_identity_provider_name}
  memorystore_instance_name: ${module.google_anyscale_v2_kitchensink.memorystore_id}
EOT
}
