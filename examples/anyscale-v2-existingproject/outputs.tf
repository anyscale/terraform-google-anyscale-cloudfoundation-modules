...
object_storage:
  bucket_name: gs://${module.google_anyscale_v2_existingproject.cloudstorage_bucket_name}
file_storage:
  file_storage_id: projects/${var.existing_project_id}/locations/${module.google_anyscale_v2_existingproject.filestore_location}/instances/${module.google_anyscale_v2_existingproject.filestore_name}
gcp_config:
  project_id: ${var.existing_project_id}
  vpc_name: ${module.google_anyscale_v2_existingproject.vpc_name}
  subnet_names:
    - ${module.google_anyscale_v2_existingproject.public_subnet_name}
  firewall_policy_names:
    - ${module.google_anyscale_v2_existingproject.vpc_firewall_policy_name}
  anyscale_service_account_email: ${module.google_anyscale_v2_existingproject.iam_anyscale_access_service_acct_email}
  cluster_service_account_email: ${module.google_anyscale_v2_existingproject.iam_anyscale_cluster_node_service_acct_email}
  provider_name: ${module.google_anyscale_v2_existingproject.iam_workload_identity_provider_name}
EOT
}
#
