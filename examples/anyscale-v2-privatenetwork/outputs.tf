...
object_storage:
  bucket_name: gs://${module.google_anyscale_v2_privatenetwork.cloudstorage_bucket_name}
file_storage:
  file_storage_id: projects/${module.google_anyscale_v2_privatenetwork.project_name}/locations/${module.google_anyscale_v2_privatenetwork.filestore_location}/instances/${module.google_anyscale_v2_privatenetwork.filestore_name}
gcp_config:
  project_id: ${module.google_anyscale_v2_privatenetwork.project_name}
  vpc_name: ${module.google_anyscale_v2_privatenetwork.vpc_name}
  subnet_names:
    - ${module.google_anyscale_v2_privatenetwork.private_subnet_name}
  firewall_policy_names:
    - ${module.google_anyscale_v2_privatenetwork.vpc_firewall_policy_name}
  anyscale_service_account_email: ${module.google_anyscale_v2_privatenetwork.iam_anyscale_access_service_acct_email}
  cluster_service_account_email: ${module.google_anyscale_v2_privatenetwork.iam_anyscale_cluster_node_service_acct_email}
  provider_name: ${module.google_anyscale_v2_privatenetwork.iam_workload_identity_provider_name}
  memorystore_instance_name: ${module.google_anyscale_v2_privatenetwork.memorystore_id}
EOT
}
#
