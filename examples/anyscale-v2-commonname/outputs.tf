...
file_storage:
  file_storage_id: projects/${module.google_anyscale_v2_commonname.project_name}/locations/${module.google_anyscale_v2_commonname.filestore_location}/instances/${module.google_anyscale_v2_commonname.filestore_name}
gcp_config:
